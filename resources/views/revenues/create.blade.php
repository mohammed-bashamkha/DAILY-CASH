<x-app-layout title="إضافة إيراد جديد">
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-800">إضافة إيراد جديد</h2>
        <div class="text-sm text-gray-500">الرئيسية / الإيرادات / إضافة</div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 max-w-2xl mx-auto">
        <form action="{{ route('revenues.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="date" id="date" value="{{ date('Y-m-d') }}" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="amount" id="amount" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500" required>
            </div>

            <div class="mb-6">
                <label for="description" class="block text-sm font-medium text-gray-700 mb-1">الوصف</label>
                <textarea name="description" id="description" rows="3" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500"></textarea>
            </div>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">حفظ</button>
            </div>
        </form>
    </div>
</x-app-layout>
