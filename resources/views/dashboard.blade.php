<x-app-layout title="لوحة التحكم المالية">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center justify-between border-r-4 border-blue-500">
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800" dir="ltr">
                    ${{ number_format($cashbox->balance ?? 0, 2) }}
                </h3>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center justify-between border-r-4 border-green-500">
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800" dir="ltr">
                    ${{ number_format($cashbox->total_income ?? 0, 2) }}
                </h3>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center justify-between border-r-4 border-red-500">
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800" dir="ltr">
                    ${{ number_format($cashbox->total_expense ?? 0, 2) }}
                </h3>
            </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-4">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 flex items-center justify-between border-r-4 border-purple-500">
        ...
        <!-- Icon (Workers) -->
        <div class="bg-purple-100 p-3 rounded-full text-purple-600 shadow-sm">
            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                <path
                    d="M13 7a3 3 0 11-6 0 3 3 0 016 0zM5 8a2 2 0 110-4 2 2 0 010 4zm10
                       0a2 2 0 110-4 2 2 0 010 4zM4 14a4 4 0 118 0v1H4v-1zm10
                       1v-1a4 4 0 00-3-3.87 5 5 0 016 4.87v1h-3z" />
            </svg>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 flex items-center justify-between border-r-4 border-green-500">
        <div>
            <p class="text-sm text-gray-500 font-medium mb-1">عدد المشاريع</p>
            <h3 class="text-2xl font-bold text-gray-800" dir="ltr">{{ $totalProjects ?? 0 }}</h3>
        </div>
        ...
        <div class="bg-green-100 p-3 rounded-full text-green-600 shadow-sm">
            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    d="M3 7a2 2 0 012-2h5l2 2h7a2 2 0 012 2v7a2 2 0 01-2
                       2H5a2 2 0 01-2-2V7zm10 3l2 2 4-4" />
            </svg>
        </div>
    </div>
</div>
