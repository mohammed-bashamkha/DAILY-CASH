...
<head>
    ...
    <title>تسجيل الدخول - Daily Cash</title>
    ...
    <div class="w-full max-w-md px-4">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500">نظام إدارة الصندوق المالي</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="text-center">
                    <p class="text-gray-600">ليس لديك حساب؟ <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-700 font-semibold">إنشاء حساب جديد</a></p>
                </div>
            </form>
        </div>
    </div>
